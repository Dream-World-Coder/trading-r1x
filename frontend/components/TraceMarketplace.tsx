...
const MOCK_RECEIPT: StorageReceipt = {
    sha256_hex:
        "a3f9d2c1e4b5f8a7d6c3b2a1e9f8d7c6b5a4f3e2d1c0b9a8f7e6d5c4b3a2f1",
                ...
                <div key={step.step} className="relative pl-8 group">
                    ...
                    <div className="rounded-lg border border-slate-700/50 bg-slate-800/50 p-3 transition-colors group-hover:border-slate-600">
                        ...
                        <div className="mt-2 flex items-start gap-1.5">
                            <span className="mt-px text-xs text-slate-500 shrink-0">
                                ↳
                            </span>
            ...
            <div className="flex items-center gap-3">
                <div className="rounded-lg border border-slate-700 bg-slate-800 px-3 py-1.5">
                    <span className="text-xs text-slate-400">
                        {balance !== undefined
                            ? `${parseFloat(formatUnits(balance as bigint, 6)).toFixed(2)} USDC`
                            : "—"}
                    </span>
                </div>
                <button
            ...
            {estimatedPayout && amount && prediction !== null && (
                <div className="rounded-lg border border-slate-700 bg-slate-800/50 p-3">
                    ...
                    <p className="mt-1 text-xs text-slate-600">
                        Based on current pool distribution. Final payout depends
                        on other wagers.
                    </p>
                </div>
            )}
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
                            ...
                            >
                                ...
                                <p
                                    className={`text-2xl font-black ${action.color}`}
                                >
                                    {action.label}
                                </p>
                            </div>
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="rounded-2xl border border-slate-800 bg-slate-900/50 p-4 space-y-2">
                            ...
                            <ul className="space-y-1 text-xs text-slate-500">
                                <li>
                                    1. The AI reasoning trace is pinned to IPFS.
                                </li>
                                <li>
                                    2. Its SHA-256 hash is registered on Arc L1.
                                </li>
                                <li>
                                    3. Wager USDC on whether the trade was
                                    profitable.
                                </li>
                                <li>
                                    4. After resolution, winners split the loser
                                    pool.
                                </li>
